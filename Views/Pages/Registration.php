...
<head>
    <meta charset="UTF-8">
    <title>AnimalShelter - Регистрация</title>
                                ...
                                <div class="form-block-row-column-input-select">
                                    <select name="roleId">
                                        <?php foreach (QueryExecutor::getInstance()->getRoles() as $role): ?>
                                            <?php if($role["name"] != "Администратор"): ?>
                        ...
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-text">
                                    <input type="text" name="fullName" value="<?php echo $_SESSION["params"]["registration"]["fullName"]; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-text">
                                    <input type="text" name="eMail" value="<?php echo $_SESSION["params"]["registration"]["eMail"]; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-text">
                                    <input type="text" name="phoneNumber" value="<?php echo $_SESSION["params"]["registration"]["phoneNumber"]; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-text">
                                    <input type="text" name="address" value="<?php echo $_SESSION["params"]["registration"]["address"]; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-date">
                                    <input type="date" name="dateOfBirth" value="<?php echo $_SESSION["params"]["registration"]["dateOfBirth"]; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-block-row">
