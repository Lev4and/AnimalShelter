...
$pet = QueryExecutor::getInstance()->getPet($_GET["petId"]);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>AnimalShelter - Изменение данных о питомце</title>
    <link rel="icon" href="/Resources/Images/Icons/Logo.png">
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/EditPet.css">
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            <div class="header-block">
                <h1>Изменение данных о питомце</h1>
            </div>
            <div class="form-block">
                <form action=".?petId=<?php echo $_GET["petId"]; ?>&photo=<?php echo $pet["photo"]; ?>" method="post" enctype="multipart/form-data">
                    <div class="form-block-image-block">
                        <div class="form-block-image-block-container">
                            <img id="pet-photo" name="photo" src="<?php echo "http://{$_SERVER["SERVER_NAME"]}/Resources/Images/Upload/{$pet["photo"]}"; ?>">
                        </div>
                    </div>
                        ...
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-text">
                                    <input type="text" name="name" value="<?php echo isset($_SESSION["params"]["editPet"]["name"]) ? $_SESSION["params"]["editPet"]["name"] : $pet["name"]; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-number">
                                    <input type="number" style="text-align: right;" name="age" min="0" max="100" value="<?php echo isset($_SESSION["params"]["editPet"]["age"]) ? $_SESSION["params"]["editPet"]["age"] : $pet["age"]; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input-textarea" class="form-block-row-column">
                                <div class="form-block-row-column-input-textarea">
                                    <textarea name="description"><?php echo isset($_SESSION["params"]["addPet"]["description"]) ? $_SESSION["params"]["addPet"]["description"] : $pet["description"]; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
