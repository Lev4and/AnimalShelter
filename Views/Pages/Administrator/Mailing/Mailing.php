...
<head>
    <meta charset="UTF-8">
    <title>AnimalShelter - Почтовая рассылка</title>
    <link rel="icon" href="/Resources/Images/Icons/Logo.png">
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/Mailing.css">
...
<div class="main">
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <?php include $_SERVER["DOCUMENT_ROOT"] . "/Views/Renders/TableMailing.php"; ?>
        <?php endif; ?>
    </div>
